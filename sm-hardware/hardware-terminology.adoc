...
DULBE
 a| 
O recurso DULBE (Deallocated or Unwritten Logical Block Error) é uma opção em unidades NVMe que permite que o array de storage EF80, EF50, EF300/EF300C ou EF600/EF600C suporte volumes com recursos provisionados.
