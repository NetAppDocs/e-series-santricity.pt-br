...
DULBE capaz
 a| 
Indica se a opção para Erro de Bloco Lógico Desalocado ou Não Escrito (DULBE) está habilitada (Sim) ou não (Não). DULBE é uma opção em unidades NVMe que permite que o array de storage EF80, EF50, EF300 ou EF600 suporte volumes com recursos provisionados.
