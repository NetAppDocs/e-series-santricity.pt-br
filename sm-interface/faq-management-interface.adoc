...
O gráfico de latência fornece estatísticas de latência, em milissegundos (ms), para volumes, grupos de volumes, pools, aplicativos e cargas de trabalho. Esse gráfico aparece nas guias Visualização Lógica, Visualização Física e Visualização de Aplicativos e Cargas de Trabalho.
...
O gráfico de IOPS exibe estatísticas de operações de entrada/saída por segundo. Na página inicial, este gráfico exibe estatísticas para o array de storage. Nas guias Visualização Lógica, Visualização Física e Visualização de Aplicativos e Cargas de Trabalho da página Desempenho, este gráfico exibe estatísticas para o array de storage, volumes, grupos de volumes, pools, aplicativos e cargas de trabalho.
...
O gráfico MiB/s exibe estatísticas de velocidade de transferência em mebibytes por segundo. Na página inicial, este gráfico exibe estatísticas do array de storage. Nas guias Visualização Lógica, Visualização Física e Visualização de Aplicativos e Cargas de Trabalho da página Desempenho, este gráfico exibe estatísticas do array de storage, volumes, grupos de volumes, pools, aplicativos e cargas de trabalho.
...
O gráfico da CPU exibe estatísticas de capacidade de processamento para cada controlador (controlador A e controlador B). CPU é a abreviação de _central processing unit_. Na página inicial, este gráfico exibe estatísticas do array de storage. Na guia Visualização Física da página Desempenho, este gráfico exibe estatísticas do array de storage e das unidades.
...
O gráfico de Headroom está relacionado à capacidade de desempenho restante para os controladores do array de storage. Esse gráfico é visível na página inicial e na guia Visualização Física da página de desempenho.
