...
Você pode visualizar dados de desempenho por aplicativo e por carga de trabalho para avaliar a latência, IOPS e MiB/s dos aplicativos e suas respectivas cargas de trabalho para otimizar o desempenho. Características como tipo de E/S, tamanho do segmento, propriedade do controlador e cache de leitura e gravação estão incluídas na configuração do volume.
