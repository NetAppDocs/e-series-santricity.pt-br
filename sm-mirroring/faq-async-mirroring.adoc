...
[NOTE]
====
O espelhamento síncrono não está disponível no array de storage EF80, EF50, EF600/EF600C ou EF300/EF300C.
...
[NOTE]
====
O espelhamento síncrono não está disponível nos sistemas de storage EF80, EF50, EF600/EF600C ou EF300/EF300C.
