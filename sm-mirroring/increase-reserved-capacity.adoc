...
. Selecione o objeto de armazenamento para o qual deseja aumentar a capacidade reservada e clique no menu:ícone de reticências[Aumentar capacidade reservada].
+
A página Aumentar Capacidade Reservada é exibida.
