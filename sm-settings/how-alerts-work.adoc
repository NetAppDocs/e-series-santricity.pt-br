...
Você pode configurar alertas no assistente de Configuração Inicial (somente para alertas por e-mail) ou na página Alertas. Para acessar a página Alertas, vá para menu:Configurações[Alertas] no painel esquerdo.
