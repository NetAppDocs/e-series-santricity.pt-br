...
+
Você adiciona capacidade a um volume selecionando menu:Armazenamento[Volumes] no painel esquerdo e, em seguida, selecionando o menu:ícone de reticências[Aumentar capacidade] para o volume.
...
Ao copiar volumes, você cria uma cópia pontual de dois volumes separados, o volume de origem e o volume de destino, no mesmo array de storage. Você pode copiar volumes selecionando menu:Storage[Volumes] e, em seguida, selecionando o ícone menu:ellipsis[Copy volume].
...
Você pode inicializar volumes selecionando menu:Storage [Volumes > ícone de reticências > Initialize volumes].
...
Você pode redistribuir volumes selecionando menu:Storage[Volumes > ícone de reticências > Redistribuir volumes].



== Alterar a propriedade do volume

Alterar a propriedade de um volume altera a propriedade preferencial do controlador desse volume. O proprietário preferencial do controlador de um volume é listado em menu:Storage[Volumes > ellipsis icon > Edit settings].

Você pode alterar a propriedade de um volume selecionando menu:Storage[Volumes > ellipsis icon > Change volume ownership].
...
Selecione o menu:Storage[Volumes > ícone de reticências > Alterar configurações de cache] para alterar as seguintes configurações de cache:
