...
. Selecione o grupo de Snapshot para o qual deseja cancelar uma imagem de Snapshot pendente e clique no menu:ícone de reticências[Cancelar imagem de Snapshot pendente].
