...
. Selecione o pool que você deseja editar e, em seguida, clique no menu:ícone de reticências[Edit Settings].
+
A janela Edit pool Setting é exibida.

. Edite as configurações do pool conforme necessário.
+
.Detalhes do campo
[%collapsible]
====
