...
. Selecione o grupo de volume que deseja editar e clique no menu:ellipsis icon[Edit Settings].
+
A janela Edit Volume Group Settings é exibida.

. Edite as configurações do grupo de volume conforme necessário.
+
.Detalhes do campo
[%collapsible]
====
