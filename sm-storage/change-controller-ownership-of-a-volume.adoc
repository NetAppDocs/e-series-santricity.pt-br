...
. Clique no ícone de menu: reticências [Change volume ownership].
+
A janela Alterar Propriedade do Volume é exibida. Todos os volumes no array de storage aparecem nesta caixa de diálogo.
