...
. Selecione o volume membro do grupo de consistência que deseja editar e, em seguida, clique no menu:ícone de reticências[Editar configurações].
+
A janela Editar volume do membro do grupo de consistência é exibida.
...
Limiar de alerta de capacidade reservada cheia
 a| 
Use a barra para ajustar o ponto percentual em que System Manager envia uma notificação de alerta quando a capacidade reservada para um volume de membro estiver quase cheia.
