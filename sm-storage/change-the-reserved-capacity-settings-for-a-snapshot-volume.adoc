...
. Selecione o volume de snapshot que você deseja editar e, em seguida, clique no menu:ellipsis icon[Edit Settings].
+
A janela Editar configurações de capacidade reservada do volume de Snapshot é exibida.
