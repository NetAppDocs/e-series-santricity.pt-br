...
. Selecione o cluster de hosts que deseja editar e clique no menu:ícone de reticências[Edit Settings].
+
Uma janela aparece que mostra as configurações atuais do cluster de hosts.
