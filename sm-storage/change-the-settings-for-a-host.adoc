...
. Selecione o host que você deseja editar e, em seguida, clique no menu:ellipsis icon[Edit Settings].
+
Uma janela aparece que mostra as configurações atuais do host.
