...
* Você também pode abrir a caixa de diálogo Consolidate Free Capacity na página Pools e grupos de volumes, conforme descrito na tarefa a seguir.
...
. Clique no ícone de menu: ellipsis [Consolidate volume group free capacity].
+
...
.Depois de terminar
Selecione menu:Storage[Operations in Progress] para visualizar o progresso da operação Consolidate Free Capacity. Esta operação pode ser demorada e pode afetar o desempenho do sistema.
