...
+
** No painel esquerdo, selecione menu:Storage[Volumes]. Selecione o objeto (volume base ou grupo de consistência de snapshot), e então clique no menu:ellipsis icon[Create instant snapshot].
** No painel esquerdo, selecione menu:Storage[Snapshots]. Selecione a guia *Snapshot Images* e, em seguida, selecione menu:Create[Instant snapshot Image].
+
