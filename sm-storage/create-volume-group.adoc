...
Resource Provisioning Capable (somente EF80, EF50, EF300 e EF600)
 a| 
Mostra se o Resource Provisioning está disponível para este grupo. Resource Provisioning é um recurso disponível nos storage arrays EF80, EF50, EF300 e EF600, que permite que os volumes sejam colocados em uso imediatamente, sem processo de inicialização em segundo plano.
