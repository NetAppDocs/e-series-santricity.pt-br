...
. Selecione o objeto de armazenamento para o qual deseja diminuir a capacidade reservada e clique no menu:ícone de reticências[Diminuir capacidade].
+
A página Diminuir Capacidade Reservada é exibida.
