...
.Passos
. No painel esquerdo, selecione menu:Storage[Snapshots].
. Clique na guia *Snapshots Schedules*.
. Selecione a programação de snapshot que deseja excluir, clique em *Delete* e confirme a operação.
