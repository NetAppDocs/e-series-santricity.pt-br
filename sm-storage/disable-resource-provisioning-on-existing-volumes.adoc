...
O provisionamento de recursos é um recurso disponível nos arrays de storage EF80, EF50, EF300/EF300C e EF600/EF600C, que permite que os volumes sejam colocados em uso imediatamente sem processo de inicialização em segundo plano. Todos os blocos de drive atribuídos ao volume são desalocados (não mapeados), o que pode melhorar a vida útil do SSD e aumentar o desempenho máximo de gravação.
...
.Antes de começar
* Você precisa ter um array de storage EF80, EF50, EF300 ou EF600.
...
. Clique no ícone de *reticências* e selecione *Ativar provisionamento de recursos* ou *Desativar provisionamento de recursos* para o pool ou grupo de volume selecionado.
