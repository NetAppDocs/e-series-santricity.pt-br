...
* Você também pode acessar menu:Storage[Pools and volume groups] no painel esquerdo e, em seguida, selecionar o menu:ellipsis icon[Consolidate volume group free capacity] para abrir a caixa de diálogo.
