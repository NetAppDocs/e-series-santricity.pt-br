...
* *Visualização de aplicativos e cargas de trabalho* -- Exibe uma lista de objetos lógicos (volumes) agrupados pelos tipos de aplicativos e cargas de trabalho que você definiu.
...
. Selecione a guia *Logical View*, a guia *Physical View* ou a guia *Applications and workloads View*.
+
...
** *Unidades*: Latência, IOPS, MIB/s
 ...
 a| 
Aplicações e cargas de trabalho Visualizar
 a| 
** *Storage array*: IOPS, MIB/s.
