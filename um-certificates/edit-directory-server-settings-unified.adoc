...
---
= Editar configurações do servidor de diretório e mapeamentos de funções no SANtricity Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Passos
. No painel esquerdo, selecione menu:Settings[Access Management].
