...
[NOTE]
====
Este recurso não está disponível nos sistemas de storage EF80, EF50, EF600/EF600C ou EF300/EF300C.
...
.Depois de terminar
Acesse o System Manager e o menu:Storage[Operations in Progress] para visualizar o progresso da operação de espelhamento síncrono. Essa operação pode ser demorada e pode afetar o desempenho do sistema.
