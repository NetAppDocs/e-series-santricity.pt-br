...
[NOTE]
====
Espelhamento síncrono não está disponível nos arrays de storage EF80, EF50, EF600/EF600C ou EF300/EF300C.
...
* Os volumes primário e secundário não devem ter o particionamento de recursos ativado.
